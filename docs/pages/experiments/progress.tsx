  ...
  return (
    <div className="ProgressDemos">
      ...
      <Progress.Root
        ...
        value={10}
        bufferValue={75}
        getAriaValueText={(value, bufferValue) => `${value}% complete, ${bufferValue}% buffered`}
      >
        ...
        <Progress.Track className="MyProgress-track">
          <Progress.Indicator className="MyProgress-indicator" />
          <Progress.Buffer className="MyProgress-buffer" />
        </Progress.Track>
      </Progress.Root>

      <h3 id="customizations">Customizations</h3>

      <Progress.Root className="MyProgress tall" value={VAL1} aria-label="loading progress">
        <Progress.Track className="MyProgress-track">
          <Progress.Indicator className="MyProgress-indicator">
            <span className="ValueText">{VAL1}%</span>
          </Progress.Indicator>
        </Progress.Track>
      </Progress.Root>
      <Styles />
