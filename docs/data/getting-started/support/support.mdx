---
title: Support
description: Learn how to get support for Base UI components, including feature requests, bug fixes, and technical support from the team.
---
...
We do not offer paid support for Base UI.
