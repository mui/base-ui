...
You can specify the `largeStep` prop to change the step when the user holds the <kbd class="Kbd">shift</kbd> key, snapping to multiples of 10 by default.
...
In a RTL Slider, <kbd class="Kbd">Left Arrow</kbd> increases the value while <kbd class="Kbd">Right Arrow</kbd> decreases the value.
