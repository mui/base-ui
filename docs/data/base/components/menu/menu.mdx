...
import { InstallationInstructions } from 'docs-base/src/modules/components/InstallationInstructions.tsx';

# Menu

<p className="description">The Menu component provide end users with a list of options on temporary surfaces.</p>
