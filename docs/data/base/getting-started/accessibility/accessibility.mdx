...
Specifically, interactive components can be focused using the <kbd class="Kbd">Tab</kbd> key.
List-like components (such as Select and Menu) can be browsed and activated using arrow keys, <kbd class="Kbd">Home</kbd>, <kbd class="Kbd">End</kbd>, <kbd class="Kbd">Enter</kbd>/<kbd class="Kbd">Return</kbd>, and <kbd class="Kbd">Escape</kbd>.
