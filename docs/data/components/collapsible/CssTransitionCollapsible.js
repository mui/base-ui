...
export function Styles() {
  ...
  return (
    ...
    .CssTransitionCollapsible-trigger[data-collapsible="open"] svg {
    ...
    .CssTransitionCollapsible-content[data-collapsible='open'] {
      height: var(--collapsible-content-height);
      transition: height 200ms ease-out;
    }

    .CssTransitionCollapsible-content[data-collapsible='closed'] {
      height: 0;
