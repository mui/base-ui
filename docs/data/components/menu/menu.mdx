...
components: MenuItem, MenuPositioner, MenuPopup, MenuRoot, MenuTrigger, SubmenuTrigger, MenuArrow, MenuGroup
...
See the [Separator docs](/components/separator/) to learn about its API.
