        ...
        {rows.map((row) => (
          <div key={row.index} className={styles.row}>
            ...
            <span className={styles.actions}>
              ...
              {renderPreviewCard && <RowPreviewCard rowData={row} />}
...
function RowPreviewCard({ rowData }: RowProps) {
  return (
    <PreviewCard.Root>
      <PreviewCard.Trigger className={styles.button} href="#" data-id={rowData.index}>
        Preview Card
      </PreviewCard.Trigger>
      <PreviewCard.Portal>
