...
function useAutofillInput(autoComplete: string) {
...
export default function Page() {
  ...
  const stateAutofillRef = useAutofillInput('address-level1');
  const suburbAutofillRef = useAutofillInput('address-level2');
          ...
          <div className={styles.Row}>
            ...
            <div className={styles.Field}>
              ...
              <Select.Root
                ...
                inputRef={stateAutofillRef}
              >
                <Select.Trigger className={styles.SelectTrigger} aria-label="State">
