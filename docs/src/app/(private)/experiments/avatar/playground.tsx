    ...
    <div className={styles.page}>
      ...
      <main className={styles.grid}>
        ...
        <Scenario
          ...
          description="Src is a 404. The browser still has to round-trip before deciding the response isn't a valid image, so status starts at 'loading' (initial render with src defined but no decoded bitmap), then flips to 'error' once `<img>` fires its error event and the fallback takes over."
