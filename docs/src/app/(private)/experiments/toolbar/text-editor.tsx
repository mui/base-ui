...
import selectClasses from '../../../(docs)/(content)/react/components/select/demos/hero/css-modules/index.module.css';
...
import numberFieldClasses from '../../../(docs)/(content)/react/components/number-field/demos/hero/css-modules/index.module.css';
