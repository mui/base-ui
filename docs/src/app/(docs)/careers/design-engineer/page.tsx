  ...
  return (
    <div className="HomepageRoot">
      ...
      <div className="ContentLayoutMain">
        ...
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">About Base UI</h2>
        <p className="mb-4">
        ...
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">The role</h2>
        <p className="mb-4">
        ...
        <ul className="mb-4 ml-4.5 list-disc">
          ...
          <li className="mb-0.5">Help out with developer support on both Github and Discord.</li>
        </ul>
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Requirements</h2>
        <ul className="mb-4 ml-4.5 list-disc">
          <li className="mb-0.5">We are targeting 7+ years of web development experience.</li>
          <li className="mb-0.5">
          ...
          <li className="mb-0.5">Excellent written and verbal communication skills.</li>
          <li className="mb-0.5">Experience working remotely and communicating asynchronously.</li>
        </ul>
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Benefits</h2>
        <ul className="mb-4 ml-4.5 list-disc">
          ...
          <li className="mb-0.5">100% remote. Our entire company is globally distributed.</li>
          <li className="mb-0.5">
        ...
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Application</h2>
