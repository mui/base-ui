...
<Subtitle>Jun 17, 2026</Subtitle>
<Meta name="description" content="v1.6.0 release notes. Jun 17, 2026." />
...
- 🚨 **Breaking change:** Unmark preview ([#5029](https://github.com/mui/base-ui/pull/5029))
