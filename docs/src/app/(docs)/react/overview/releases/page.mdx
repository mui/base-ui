...
- Fix visually hidden input styles ([#3606](https://github.com/mui/base-ui/pull/3606))
- Fix a click and drag outside a nested popup component from closing its parents ([#3571](https://github.com/mui/base-ui/pull/3571))
...
- Add `side` and `empty` state attributes to `Trigger` ([#3491](https://github.com/mui/base-ui/pull/3491))
...
- Add `loopFocus` prop ([#3592](https://github.com/mui/base-ui/pull/3592))
- Align multiple values label resolution in `Value` component ([#3314](https://github.com/mui/base-ui/pull/3314))
- Add `toolbar` role to `<Combobox.Chips>` part ([#3647](https://github.com/mui/base-ui/pull/3647))
- Add `placeholder` prop to `Value` part ([#3604](https://github.com/mui/base-ui/pull/3604))
...
- Add `actionsRef` ([#3395](https://github.com/mui/base-ui/pull/3395))
...
- Fix Field focused state ([#3563](https://github.com/mui/base-ui/pull/3563))
...
- Refactor popup auto resize logic. It is no longer necessary to specify `--positioner-width`/`--positioner-height` CSS variables unless the `Viewport` part has been added to the JSX. ([#3652](https://github.com/mui/base-ui/pull/3652))
- Fix focus guard handling ([#3654](https://github.com/mui/base-ui/pull/3654))
...
- Fix range slider `onValueCommitted` not called ([#3600](https://github.com/mui/base-ui/pull/3600))
