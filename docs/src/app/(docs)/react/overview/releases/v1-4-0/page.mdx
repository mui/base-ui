...
<Subtitle>Apr 10, 2026</Subtitle>
<Meta name="description" content="v1.4.0 release notes. Apr 10, 2026." />
...
- Add preview `OTP Field` component for one-time password and verification code entry ([#4365](https://github.com/mui/base-ui/pull/4365))
