...
- Fire Space activation on `keydown` in composite widgets ([##4053](https://github.com/mui/base-ui/pull/#4053))
...
- Add `SwipeArea` component ([##4102](https://github.com/mui/base-ui/pull/#4102))
...
- Fix incorrect `reason` value in `onValueCommitted` ([##4259](https://github.com/mui/base-ui/pull/#4259))
