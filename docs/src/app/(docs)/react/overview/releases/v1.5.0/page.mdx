...
- Use floating document for virtual arrow ([#4662](https://github.com/mui/base-ui/pull/4662))
...
- Don't steal initial focus if focus already moved inside the floating element ([#4775](https://github.com/mui/base-ui/pull/4775))

## Accordion

- Refactor key handling to use `COMPOSITE_KEYS` for consistency ([#4744](https://github.com/mui/base-ui/pull/4744))
...
- Refactor panel logic ([#4565](https://github.com/mui/base-ui/pull/4565))
...
- Bump timeout for `<Menu.LinkItem>` keyboard navigation e2e test ([#4746](https://github.com/mui/base-ui/pull/4746))
...
- Avoid `flushSync` during validation ([#4685](https://github.com/mui/base-ui/pull/4685))
- Support ctrl/cmd keyboard shortcuts ([#4606](https://github.com/mui/base-ui/pull/4606))
...
- Drop redundant `fieldState` merge in `<Switch.Thumb>` ([#4692](https://github.com/mui/base-ui/pull/4692))
...
- Reuse `getDisplacement()` ([#4748](https://github.com/mui/base-ui/pull/4748))
