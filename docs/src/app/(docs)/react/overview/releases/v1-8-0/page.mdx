...
<Subtitle>Sep 2, 2026</Subtitle>
<Meta name="description" content="v1.8.0 release notes. Sep 2, 2026." />
...
- Make the multiple selection anchor lookup linear ([#5613](https://github.com/mui/base-ui/pull/5613))
...
- Replace custom data wholesale and accept a function to derive it ([#5611](https://github.com/mui/base-ui/pull/5611))
