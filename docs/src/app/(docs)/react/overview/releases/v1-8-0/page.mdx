...
- Stabilize indicator animation test ([#5467](https://github.com/mui/base-ui/pull/5467))
...
- Allow opening and browsing the popup while read-only ([#5541](https://github.com/mui/base-ui/pull/5541))
...
- Remove duplicate React import ([#5486](https://github.com/mui/base-ui/pull/5486))
