...
[shadcn/ui](https://ui.shadcn.com) is a great place to start if you need pre-styled components with higher-level abstractions while using Base UI under the hood.
...
You can also subscribe to the GitHub repository's [releases](https://github.com/mui/base-ui/releases) to get notified.
