...
| style           | `React.CSSProperties \| ((state: Checkbox.Root.State) => React.CSSProperties \| undefined)` | -           | -                                                                                                                                                                                             |
...
| style       | `React.CSSProperties \| ((state: Checkbox.Indicator.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
