...
export default function ExampleAccordion() {
  return (
    <Accordion.Root className="flex w-80 max-w-full flex-col border-b border-neutral-950 text-neutral-950 dark:border-white dark:text-white">
      <Accordion.Item>
        <Accordion.Header>
          <Accordion.Trigger className="group flex w-full items-center justify-between gap-4 border-t border-neutral-950 bg-transparent py-2 text-left text-sm leading-5 font-normal text-neutral-950 select-none focus-visible:z-1 focus-visible:outline-2 focus-visible:outline-blue-800 dark:border-white dark:text-white">
            What is Base UI?
