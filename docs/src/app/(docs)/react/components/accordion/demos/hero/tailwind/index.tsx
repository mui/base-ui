...
export default function ExampleAccordion() {
  return (
    <Accordion.Root className="flex w-80 max-w-full flex-col border-b border-gray-900 text-gray-900 dark:border-gray-50 dark:text-gray-50">
      <Accordion.Item>
        <Accordion.Header>
          <Accordion.Trigger className="group flex w-full items-center justify-between gap-4 border-t border-gray-900 bg-transparent py-2 text-left text-sm leading-5 font-normal text-gray-900 select-none focus-visible:z-1 focus-visible:outline-2 dark:border-gray-50 dark:text-gray-50">
            What is Base UI?
