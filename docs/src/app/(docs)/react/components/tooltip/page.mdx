...
To animate content that changes in place, such as a status message that updates over time, pass a `transitionKey` and update it whenever the content changes.
