...
<Tooltip.Trigger handle={demoTooltip}>Button</Tooltip.Trigger> {/* @highlight-text "handle={demoTooltip}" */}

<Tooltip.Root handle={demoTooltip}> {/* @highlight-text "handle={demoTooltip}" */}
  ...
</Tooltip.Root>
```
...
{/* @highlight-start */}
<Tooltip.Trigger handle={demoTooltip} payload={{ text: 'Trigger 1' }}> {/* @highlight-text "payload" */}
{/* @highlight-end */}
  Trigger 1
</Tooltip.Trigger>

{/* @highlight-start */}
<Tooltip.Trigger handle={demoTooltip} payload={{ text: 'Trigger 2' }}> {/* @highlight-text "payload" */}
{/* @highlight-end */}
  Trigger 2
</Tooltip.Trigger>
