  ...
  return (
    <NumberField.Root id={id} defaultValue={100} className="flex flex-col items-start gap-1">
      ...
      <NumberField.Group className="flex h-8">
        ...
        <NumberField.Input className="h-full w-[7ch] border-y border-neutral-950 rounded-none bg-white dark:bg-neutral-950 px-3 text-left text-sm font-normal text-neutral-950 tabular-nums focus:z-1 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-800 dark:border-white dark:text-white" />
