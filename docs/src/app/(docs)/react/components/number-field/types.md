...
| locale           | `IntlLocalesArgument`                                                                  | -       | The locale of the input element.&#xA;Defaults to the user's runtime locale.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
type NumberFieldRootCommitEventDetails =
  ...
  | { reason: 'increment-press'; event: MouseEvent | TouchEvent | PointerEvent }
  | { reason: 'decrement-press'; event: MouseEvent | TouchEvent | PointerEvent }
