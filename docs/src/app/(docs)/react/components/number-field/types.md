...
| valueChangeAction | `((value: number \| null, eventDetails: NumberField.Root.ChangeEventDetails) => void \| PromiseLike<unknown>)` | -       | Async function that is executed when the number value changes.&#xA;It runs in a React Transition and updates the field optimistically while pending. Use this when the value change needs to perform async work, such as sending the new&#xA;value to a server.                                                                                                                                                                                                                                                                                                                                                  |
