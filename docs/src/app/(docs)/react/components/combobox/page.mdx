...
import {
  ...
  TypesComboboxRow,
  TypesComboboxItem,
  TypesComboboxItemIndicator,
  TypesComboboxGroup,
  TypesComboboxGroupLabel,
  TypesComboboxSeparator,
  TypesComboboxUseFilter,
  TypesComboboxUseFilteredItems,
} from './types';
...
<TypesComboboxUseFilter hideDescription />

### useFilteredItems

Returns the internally filtered items when called inside `<Combobox.Root>`.

<TypesComboboxUseFilteredItems hideDescription />
