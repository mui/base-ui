...
| actionsRef           | `React.RefObject<Combobox.Root.Actions \| null>`                                                        | -       | A ref to imperative actions. `unmount`: Manually unmounts the combobox once its closing animation has finished.&#xA;Useful when the animation is controlled by an external JavaScript animation library.                                                                                                                                                                                                                                                                                                                                                              |
