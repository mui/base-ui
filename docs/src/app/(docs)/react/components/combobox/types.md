...
| Prop      | Type                                                                                                     | Default | Description                                                                                                                                                                                   |
| :-------- | :------------------------------------------------------------------------------------------------------- | :------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| children  | `React.ReactNode \| ((item: any, index: number, meta: Combobox.Collection.ItemMeta) => React.ReactNode)` | -       | -                                                                                                                                                                                             |
...
| Prop       | Type                                                                                  | Default | Description |
| :--------- | :------------------------------------------------------------------------------------ | :------ | :---------- |
| children\* | `((item: any, index: number, meta: Combobox.Collection.ItemMeta) => React.ReactNode)` | -       | -           |
...
```typescript
type ComboboxCollectionItemMeta = {
  /**
...
| className    | `string \| ((state: Combobox.CreateItem.State) => string \| undefined)`                           | -       | CSS class applied to the element, or a function that&#xA;returns a class based on the component's state.                                                                                                                                                               |
| style        | `React.CSSProperties \| ((state: Combobox.CreateItem.State) => React.CSSProperties \| undefined)` | -       | Style applied to the element, or a function that&#xA;returns a style object based on the component's state.                                                                                                                                                            |
| render       | `ReactElement \| ((props: HTMLProps, state: Combobox.CreateItem.State) => ReactElement)`          | -       | Allows you to replace the component's HTML element&#xA;with a different tag, or compose it with another component. Accepts a `ReactElement` or a function that returns the element to render.                                                                          |
...
- `Combobox.CreateItem`: `Combobox.CreateItem`, `Combobox.CreateItem.State`, `Combobox.CreateItem.Props`
...
- `Combobox.Collection`: `Combobox.Collection`, `Combobox.Collection.State`, `Combobox.Collection.Props`, `Combobox.Collection.ItemMeta`
...
- `Combobox.CreateItem.State`: `ComboboxCreateItemState`
- `Combobox.CreateItem.Props`: `ComboboxCreateItemProps`
...
- `Combobox.Collection.ItemMeta`: `ComboboxCollectionItemMeta`
