  ...
  return (
    <Combobox.Root items={langs} multiple>
      <div className="max-w-md flex flex-col gap-1">
        ...
        <Combobox.InputGroup className="flex min-h-8 w-64 cursor-text flex-wrap items-center gap-0.5 border border-neutral-950 bg-white px-2 py-1 focus-within:outline-2 focus-within:-outline-offset-1 focus-within:outline-neutral-950 has-[button]:px-1 dark:border-white dark:bg-neutral-950 dark:focus-within:outline-white min-[32rem]:w-[22rem]">
              ...
              {(value: ProgrammingLanguage[]) => (
                <React.Fragment>
                  ...
                  <Combobox.Input
                    ...
                    className="h-[calc(1.5rem-2px)] min-w-12 flex-1 border-0 bg-white p-0 text-sm font-normal text-neutral-950 outline-none placeholder:text-neutral-500 any-pointer-coarse:text-base dark:bg-neutral-950 dark:text-white dark:placeholder:text-neutral-400"
                  />
                </React.Fragment>
              )}
            </Combobox.Value>
