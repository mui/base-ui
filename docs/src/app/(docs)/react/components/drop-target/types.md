...
| getPayload         | `((context: DropTargetResolutionContext<TSourceData>) => TLocalData) \| ((context: DropTargetResolutionContext<TSourceData>) => undefined) \| ((context: DropTargetResolutionContext<TPayload \| unknown>) => TLocalData) \| ((context: DropTargetResolutionContext<TPayload \| unknown>) => undefined)`                                                                                                                                                                                                                                                             | -       | Resolves payload data from the current drag context.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
type DropTargetRootPropsWithPayload<TSourceData, TLocalData> = (
  | { payload: TLocalData | undefined; getPayload?: undefined }
  | {
      payload?: undefined;
      getPayload: ((context: DropTargetResolutionContext<TSourceData>) => TLocalData) | undefined;
    }
) & {
  /**
