...
| :----------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| accept\*           | `NonNullable<DragAccept<TSourceData> \| undefined> \| DragKind<TPayload \| unknown> & AnyDragAccept \| (DragKind<TPayload \| unknown>)[] & AnyDragAccept`                                                                                                                                                                                                                                                                                                                                                                                                                                        | -       | One or more drag source kinds accepted by this target. Every registration uses the same page-wide drag manager, so this value is&#xA;required. Pass `DropTarget.anyKind` to accept every drag. In that case,&#xA;`source.payload` is `unknown`. The target ignores a source whose kind is not accepted. An ancestor target can&#xA;still accept it. Base UI checks `accept` before `canDrop`.                                                                                                                                                                                                                                                                                                                        |
