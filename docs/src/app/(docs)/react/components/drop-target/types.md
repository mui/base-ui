...
| trackOver          | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `true`  | Whether to update over-state and its data attributes. Set to `false` when&#xA;the target renders no over feedback; drag callbacks still fire.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| data-over           | -    | Present while a matching drag source is over the target or a nested descendant.&#xA;Absent when `trackOver` is `false`.                                                                                                   |
| data-over-innermost | -    | Present while the target is the innermost one under the source.&#xA;Absent when `trackOver` is `false`.                                                                                                                   |
