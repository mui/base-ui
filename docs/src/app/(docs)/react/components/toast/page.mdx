...
import {
  ...
  TypesToastContent,
  TypesToastTitle,
  TypesToastDescription,
  TypesToastAction,
  TypesToastClose,
  TypesToastPositioner,
  TypesToastArrow,
  TypesToastUseToastManager,
  TypesToastAdditionalTypes,
} from './types';
...
<TypesToastUseToastManager hideDescription />
...
See full [`promise` method options](#toastmanagerpromiseoptions)
