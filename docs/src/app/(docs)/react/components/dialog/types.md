...
| actionsRef              | `React.RefObject<Dialog.Root.Actions \| null>`                            | -       | A ref to imperative actions. `unmount`: Manually unmounts the dialog once its closing animation has finished.&#xA;Useful when the animation is controlled by an external JavaScript animation library.`close`: Closes the dialog imperatively when called.                                                                                                                                                                                                                                                                                                                                    |
