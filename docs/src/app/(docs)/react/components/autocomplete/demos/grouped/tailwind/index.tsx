    ...
    <Autocomplete.Root items={groupedTags}>
      ...
      <Autocomplete.Portal>
        <Autocomplete.Positioner className="outline-hidden" sideOffset={4}>
          <Autocomplete.Popup className="w-[var(--anchor-width)] max-h-[22.5rem] max-w-[var(--available-width)] rounded-lg bg-[canvas] text-neutral-900 outline-1 outline-neutral-200 shadow-lg shadow-neutral-200 dark:outline-neutral-300 dark:shadow-none">
            <Autocomplete.Empty>
