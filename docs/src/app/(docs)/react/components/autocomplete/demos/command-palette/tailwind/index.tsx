          ...
          >
            ...
            >
              ...
              <ScrollArea.Root className="relative flex max-h-[min(60dvh,24rem)] min-h-0 flex-[0_1_auto] overflow-hidden border-t border-neutral-950 dark:border-t-white">
                ...
                <ScrollArea.Scrollbar className="relative flex w-2 justify-center bg-black/12 opacity-0 transition-opacity duration-150 pointer-events-none before:absolute before:content-[''] before:inset-y-0 before:-inset-x-1.5 data-hovering:opacity-100 data-hovering:pointer-events-auto data-scrolling:opacity-100 data-scrolling:duration-0 data-scrolling:pointer-events-auto dark:bg-white/12">
