...
import {
  ...
  TypesAutocompleteInput,
  TypesAutocompleteTrigger,
  TypesAutocompleteIcon,
  TypesAutocompleteClear,
  TypesAutocompleteList,
  TypesAutocompletePortal,
  TypesAutocompleteBackdrop,
  TypesAutocompletePositioner,
  TypesAutocompletePopup,
  TypesAutocompleteArrow,
  TypesAutocompleteStatus,
  TypesAutocompleteEmpty,
  TypesAutocompleteCollection,
  TypesAutocompleteRow,
  TypesAutocompleteItem,
  TypesAutocompleteGroup,
  TypesAutocompleteGroupLabel,
  TypesAutocompleteSeparator,
  TypesAutocompleteUseFilter,
  TypesAutocompleteUseFilteredItems,
} from './types';
...
<TypesAutocompleteUseFilter hideDescription />

### useFilteredItems

Returns the internally filtered items when called inside `<Autocomplete.Root>`.

<TypesAutocompleteUseFilteredItems hideDescription />
