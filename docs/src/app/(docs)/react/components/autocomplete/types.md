...
| focusItemOnOpen      | `boolean \| 'auto'`                                                                                             | `'auto'` | Controls whether an item is focused when the popup opens. `false`: no item is focused when the popup opens.`true`: an item is always focused when the popup opens.`'auto'`: focus behavior is determined automatically based on selection mode and query state.                                                                                                                                                                                                                                                                                                                                                                    |
