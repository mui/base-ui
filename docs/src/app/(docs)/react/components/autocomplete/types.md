...
| filter               | `((item: Item, query: string, itemToString?: ((item: Item) => string)) => boolean) \| null`                   | -        | AutocompleteFilter function used to match items vs input query.&#xA;Receives the source item, which is the derived value's item when `items` is a `useItems()`&#xA;collection, and the item itself otherwise.                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| items                | `({ items: any[] })[] \| ItemValue[] \| AutocompleteItemCollection<Item, ItemValue>`                          | -        | The items to be displayed in the list.&#xA;Can be either a flat array of items or an array of groups with items.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
