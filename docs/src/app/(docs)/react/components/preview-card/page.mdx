...
- **Keep popup content supplementary**: Avoid placing unique or essential information in the popup unless it is also available on the linked page. For the reason above, preview cards are a visual enhancement for sighted mouse and keyboard users. They do not open on touch, and their contents are not keyboard navigable or available to screen reader users.
