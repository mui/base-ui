...
{/* @highlight-start */}
<PreviewCard.Trigger handle={demoPreviewCard} href="#"> {/* @highlight-text "handle={demoPreviewCard}" */}
{/* @highlight-end */}
  Link
{/* @highlight */}
</PreviewCard.Trigger>

<PreviewCard.Root handle={demoPreviewCard}> {/* @highlight-text "handle={demoPreviewCard}" */}
  ...
</PreviewCard.Root>
```
...
{/* @highlight-start */}
<PreviewCard.Trigger handle={demoPreviewCard} payload={{ title: 'Trigger 1' }} href="#"> {/* @highlight-text "payload" */}
{/* @highlight-end */}
  Trigger 1
</PreviewCard.Trigger>

{/* @highlight-start */}
<PreviewCard.Trigger handle={demoPreviewCard} payload={{ title: 'Trigger 2' }} href="#"> {/* @highlight-text "payload" */}
{/* @highlight-end */}
  Trigger 2
</PreviewCard.Trigger>
