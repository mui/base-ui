                ...
                {groupedProduce.map((group, index) => (
                  <React.Fragment key={group.value}>
                    <Select.Group className="block pb-0.5">
                      <Select.GroupLabel className="sticky top-0 z-[1] bg-white pr-4 pb-1 pl-[1.875rem] pt-2 text-[0.6875rem] font-bold text-gray-500 uppercase tracking-wider dark:bg-gray-950 dark:text-gray-400">
                        {group.value}
                      </Select.GroupLabel>
