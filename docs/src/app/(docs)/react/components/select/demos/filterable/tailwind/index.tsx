    ...
    <div className="flex flex-col items-start gap-1">
      <FilterableSelect.Root filter>
        ...
        <FilterableSelect.Portal>
          <FilterableSelect.Positioner className="z-10 outline-hidden select-none" sideOffset={4}>
            <FilterableSelect.Popup className="min-w-[var(--anchor-width)] origin-[var(--transform-origin)] overflow-hidden border border-neutral-950 bg-white bg-clip-padding text-neutral-950 shadow-[0.25rem_0.25rem_0] shadow-black/12 transition-[scale,opacity] duration-100 ease-out outline-hidden data-ending-style:scale-[0.98] data-ending-style:opacity-0 data-starting-style:scale-[0.98] data-starting-style:opacity-0 dark:border-white dark:bg-neutral-950 dark:text-white dark:shadow-none">
              ...
              <FilterableSelect.Empty className="p-3 text-sm text-neutral-500 dark:text-neutral-400">
                No fruits found.
              </FilterableSelect.Empty>
              <FilterableSelect.List className="max-h-[min(16rem,var(--available-height))] overflow-y-auto py-1 scroll-py-1 empty:py-0">
                {fruits.map((fruit) => (
                  ...
                  >
                    <FilterableSelect.ItemIndicator className="col-start-1">
                      <CheckIcon />
                    </FilterableSelect.ItemIndicator>
                    <FilterableSelect.ItemText className="col-start-2">
                      {fruit}
