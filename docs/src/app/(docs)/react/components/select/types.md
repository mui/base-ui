...
| filter               | `boolean \| SelectFilter`                                                                   | `false` | Enables filtering. Pass a function to customize how items match the query.                                                                                                                                                                                                                                                                                                                                                                        |
...
```typescript
type SelectRootInputValueChangeEventReason = 'input-change' | 'input-clear' | 'clear-press';
```
