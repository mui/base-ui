...
| getItemKey          | `((item: SelectItemData<Value>) => string \| number)`                                            | -       | Returns a stable key for the item.                                                                                                                                                            |
...
| children            | `((item: SelectItemData<Value>, index: number) => ReactElement)`                                 | -       | Renders exactly one item for the given item data and logical index.                                                                                                                           |
