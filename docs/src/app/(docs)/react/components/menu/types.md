...
| style        | `React.CSSProperties \| ((state: Menu.Trigger.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style       | `React.CSSProperties \| ((state: Menu.Portal.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Menu.Backdrop.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style      | `React.CSSProperties \| ((state: Menu.Popup.State) => React.CSSProperties \| undefined)`                                      | -       | -                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| style     | `React.CSSProperties \| ((state: Menu.Arrow.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| onClick      | `React.MouseEventHandler<HTMLElement>`                                                  | -       | The click handler for the menu item.                                                                                                                                                          |
...
| style        | `React.CSSProperties \| ((state: Menu.Item.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Menu.Group.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Menu.GroupLabel.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
```typescript
type MenuSeparatorState = { orientation: Separator.Orientation };
```
...
| style        | `React.CSSProperties \| ((state: Menu.SubmenuTrigger.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style         | `React.CSSProperties \| ((state: Menu.RadioGroup.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style        | `React.CSSProperties \| ((state: Menu.RadioItem.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style       | `React.CSSProperties \| ((state: Menu.RadioItemIndicator.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style           | `React.CSSProperties \| ((state: Menu.CheckboxItem.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style       | `React.CSSProperties \| ((state: Menu.CheckboxItemIndicator.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
