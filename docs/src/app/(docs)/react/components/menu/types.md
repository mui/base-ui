...
type MenuRootActions = {
  unmount: () => void;
  close: () => void;
  highlightItem: (target: Menu.Root.HighlightItem) => void;
};
```
...
```typescript
type MenuRootHighlightItem = 'first' | 'last' | 'none';
```
...
```typescript
function open(triggerId: string, highlightItem?: Menu.Root.HighlightItem | undefined): void;
```
...
- `Menu.Root`: `Menu.Root`, `Menu.Root.State`, `Menu.Root.Props`, `Menu.Root.Actions`, `Menu.Root.HighlightItem`, `Menu.Root.ChangeEventReason`, `Menu.Root.ChangeEventDetails`, `Menu.Root.Orientation`
...
- `Menu.Root.HighlightItem`: `MenuRootHighlightItem`
