...
type MenuRootHighlightEventDetails = {
  ...
  reason: Menu.Root.HighlightEventReason;
...
| Prop         | Type                                                                                    | Default | Description                                                                                                                                                                                   |
| :----------- | :-------------------------------------------------------------------------------------- | :------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| label        | `string`                                                                                | -       | Overrides the text used for keyboard text navigation and filtering inside&#xA;`Menu.FilterProvider`. Falls back to the rendered text when not provided.                                       |
