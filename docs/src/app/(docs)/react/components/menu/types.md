...
| filter               | `boolean \| MenuFilter`                                                           | `false`      | Enables filtering. Pass a function to customize how items match the query.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
```typescript
type MenuRootInputValueChangeEventReason = 'input-change' | 'input-clear' | 'clear-press';
```
