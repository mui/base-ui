...
| Prop         | Type                                                                                    | Default | Description                                                                                                                                                                                   |
| :----------- | :-------------------------------------------------------------------------------------- | :------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| label        | `string`                                                                                | -       | Overrides the text used for keyboard text navigation and filtering inside `Menu.FilterProvider`.&#xA;Falls back to the rendered text when not provided.                                       |
...
| Prop      | Type                                                                                           | Default | Description                                                                                                                                                                                   |
| :-------- | :--------------------------------------------------------------------------------------------- | :------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| autoFocus | `boolean`                                                                                      | `false` | Whether to focus the input whenever the popup opens, including when a submenu opens on hover.&#xA;Focus is applied after the popup is positioned, rather than only when the input mounts.     |
