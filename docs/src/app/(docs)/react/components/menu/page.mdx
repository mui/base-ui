...
A modal filterable menu (the default) keeps focus inside its popup like a dialog, and renders a visually hidden close button so screen reader users can leave it.
