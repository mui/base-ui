...
A modal filterable menu (the default) opened with the keyboard or a pointer keeps focus inside its popup until Escape closes it.
Touch and hover opens leave focus free.
