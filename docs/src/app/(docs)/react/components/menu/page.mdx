...
To create a menu that opens on hover, add the `openOnHover` prop to the Trigger part. You can additionally configure how quickly the menu opens on hover using the `delay` prop.
