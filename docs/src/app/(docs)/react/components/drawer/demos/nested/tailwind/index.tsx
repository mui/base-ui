...
export default function ExampleDrawerNested() {
  ...
  const popupClassName =
    'group/popup relative -mb-[3rem] w-full max-w-md max-h-[calc(80vh+3rem)] [height:var(--drawer-height,auto)] rounded-t-2xl bg-gray-50 px-6 pt-4 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px)+3rem)] text-gray-900 outline outline-1 outline-gray-200 overflow-y-auto shadow-[0_2px_10px_rgb(0_0_0/0.1)] [--bleed:3rem] [--peek:1rem] [--scale:calc(max(0,1-(var(--drawer-nested-dialogs)*0.05)))] [--shrink:calc(1-var(--scale))] [--height:max(0px,calc(var(--drawer-frontmost-height,var(--drawer-height,0px))-var(--bleed)))] [transform-origin:50%_calc(100%-var(--bleed))] [transform:translateY(calc(var(--drawer-swipe-movement-y,0px)-(var(--drawer-nested-dialogs)*var(--peek))-(var(--shrink)*var(--height))))_scale(var(--scale))] data-[ending-style]:[transform:translateY(calc(100%+var(--drawer-swipe-movement-y,0px)))_scale(var(--scale))] data-[starting-style]:[transform:translateY(calc(100%+var(--drawer-swipe-movement-y,0px)))_scale(var(--scale))] data-[ending-style]:duration-[180ms] data-[ending-style]:ease-[cubic-bezier(0.375,0.015,0.545,0.455)] data-[nested-drawer-open]:h-[calc(var(--height)+var(--bleed))] data-[nested-drawer-open]:overflow-hidden data-[nested-drawer-open]:after:absolute data-[nested-drawer-open]:after:inset-0 data-[nested-drawer-open]:after:rounded-[inherit] data-[nested-drawer-open]:after:bg-black/5 dark:outline-gray-300 [transition:transform_525ms_cubic-bezier(0.45,1.005,0,1.005),height_0.15s]';

  const contentClassName =
    'transition-opacity duration-[350ms] group-data-[nested-drawer-open]/popup:opacity-0 group-data-[nested-drawer-swiping]/popup:opacity-100';
