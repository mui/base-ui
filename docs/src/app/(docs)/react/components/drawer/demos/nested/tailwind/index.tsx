            ...
            <Drawer.Content className={contentClassName}>
              ...
              <div className="flex items-center justify-end gap-4">
                <div className="mr-auto">
                  <Drawer.Root>
                    <Drawer.Trigger className="flex h-8 items-center justify-center bg-neutral-50 px-3 text-sm font-normal text-neutral-950 hover:bg-neutral-100 active:bg-neutral-200 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 dark:active:bg-neutral-700 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-blue-800">
                      Security settings
                    </Drawer.Trigger>
                    <Drawer.Portal>
                      <Drawer.Viewport className="fixed inset-0 flex items-end justify-center">
