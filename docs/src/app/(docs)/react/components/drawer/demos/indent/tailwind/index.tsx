...
export default function ExampleDrawer() {
  ...
  return (
    <div className="relative w-full min-h-[200px] flex items-center justify-center perspective-[1000px]">
      <div
        className={`flex items-center justify-center w-full h-full p-8 rounded-xl bg-gray-100 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] origin-top ${open ? 'scale-[0.94] -translate-y-2 rounded-2xl' : ''}`}
      >
