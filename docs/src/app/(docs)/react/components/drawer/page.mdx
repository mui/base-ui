...
Create an iOS-style "indent" effect where the background zooms out when the drawer opens:

import { DemoDrawerIndent } from './demos/indent';

<DemoDrawerIndent />

This effect is achieved by controlling the drawer state and applying a scale transform to the background content based on the open state.
