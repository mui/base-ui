...
Keep the popup frame stable and place header and footer content outside a plain scrollable body. The provider scrolls the focused field into the visible viewport when the keyboard opens.
