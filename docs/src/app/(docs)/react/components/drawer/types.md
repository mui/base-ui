...
| actionsRef              | `React.RefObject<Drawer.Root.Actions \| null>`                                                          | -        | A ref to imperative actions. `unmount`: Manually unmounts the drawer once its closing animation has finished.&#xA;Useful when the animation is controlled by an external JavaScript animation library.`close`: Closes the drawer imperatively when called.                                                                                                                                                                                        |
