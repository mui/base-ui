...
| virtualKeyboardAvoidance | `DrawerRootVirtualKeyboardAvoidance`                                                                    | -        | A component that wraps the drawer contents to provide keyboard-aware focus and&#xA;scroll handling for software keyboards. Pass `Drawer.virtualKeyboardAvoidance`&#xA;to opt in. Only applies when `swipeDirection` is `'down'`.                                                                                                                                                                                                                  |
...
**virtualKeyboardAvoidance Props:**
...
### DrawerRootVirtualKeyboardAvoidance

```typescript
type DrawerRootVirtualKeyboardAvoidance =
  React.ComponentType<DrawerRootVirtualKeyboardAvoidanceProps>;
```

### DrawerRootVirtualKeyboardAvoidanceProps

```typescript
type DrawerRootVirtualKeyboardAvoidanceProps = {
