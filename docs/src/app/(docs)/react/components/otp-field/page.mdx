...
`<OTPField.Group>` when you need supporting description text:

```tsx title="OTP Field with a native label and description" {2,4,14}
<OTPField.Root id="verification-code" length={6}>
  <label htmlFor="verification-code">Verification code</label>
  <OTPField.Group aria-describedby="verification-code-description">
