...
<Form>
  <Field.Root name="verificationCode">
    ...
    <OTPField.Root length={6}>
      <OTPField.Group>
        <OTPField.Input aria-label="Character 1 of 6"></OTPField.Input>
        <OTPField.Input aria-label="Character 2 of 6"></OTPField.Input>
        <OTPField.Input aria-label="Character 3 of 6"></OTPField.Input>
        <OTPField.Input aria-label="Character 4 of 6"></OTPField.Input>
        <OTPField.Input aria-label="Character 5 of 6"></OTPField.Input>
        <OTPField.Input aria-label="Character 6 of 6"></OTPField.Input>
      </OTPField.Group>
    </OTPField.Root>
  </Field.Root>
</Form>
