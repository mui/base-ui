...
import { DemoFullscreenDetachedTrigger } from './demos/detached-trigger';

<DemoFullscreenDetachedTrigger />
...
import { DemoFullscreenPortal } from './demos/portal';

<DemoFullscreenPortal />
...
import { DemoFullscreenPage } from './demos/page-fullscreen';
...
<TypesFullscreen.Portal />

### Handle

<TypesFullscreen.Handle />
