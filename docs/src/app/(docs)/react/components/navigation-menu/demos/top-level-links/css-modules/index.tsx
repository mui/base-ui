    ...
    <NavigationMenu.Root className={styles.Root}>
      <NavigationMenu.List className={styles.List}>
        <NavigationMenu.Item value="overview">
          <NavigationMenu.TriggerGroup className={styles.TopItem}>
        ...
        <NavigationMenu.Item value="handbook">
          <NavigationMenu.TriggerGroup className={styles.TopItem}>
            <NavigationMenu.TriggerLink className={styles.TopLink} href="/react/handbook/styling">
              Handbook
            </NavigationMenu.TriggerLink>
            <NavigationMenu.Trigger
              className={styles.ChevronTrigger}
        ...
        <li>
          <a
            className={`${styles.TopLink} ${styles.TopStandaloneLink}`}
