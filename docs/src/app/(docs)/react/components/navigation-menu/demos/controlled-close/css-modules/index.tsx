...
export default function ExampleNavigationMenu() {
  ...
  return (
    <NavigationMenu.Root className={styles.Root} value={value} onValueChange={setValue}>
      <label className={styles.Control}>
        <input
          type="checkbox"
          checked={value != null}
          onChange={(event) => setValue(event.currentTarget.checked ? 'overview' : null)}
        />
        Menu open
      </label>
...
const handbookLinks = [
  {
    ...
    title: 'Styling',
    description: 'Style Base UI components with plain CSS, Tailwind CSS, or CSS Modules.',
  },
  {
    href: '/react/handbook/animation',
    title: 'Animation',
    description: 'Animate components with CSS transitions, CSS animations, or JavaScript.',
  },
  {
    href: '/react/handbook/composition',
    title: 'Composition',
    description: 'Replace and compose parts with your own existing components.',
  },
] as const;
