...
You can compose external animation libraries like [Motion](https://motion.dev/) with calendar parts while using `<Calendar.Viewport>` to handle month transitions.
