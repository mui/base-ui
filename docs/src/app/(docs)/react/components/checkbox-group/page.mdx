...
The group controls the parent checkbox's [indeterminate](/react/components/checkbox#indeterminate) state when some, but not all, child checkboxes are checked.
