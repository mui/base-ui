...
Place `<CheckboxGroupPaintSelectionProvider>` inside `<CheckboxGroup>`, around the checkboxes, to enable paint selection.
...
### Paint selection provider

<TypesCheckboxGroup.CheckboxGroupPaintSelectionProvider />
