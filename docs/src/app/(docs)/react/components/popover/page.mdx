...
To animate content that changes in place under a single trigger, such as steps of a flow, pass a `transitionKey` and update it whenever the content changes.
