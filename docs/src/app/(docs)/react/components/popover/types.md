...
| style       | `React.CSSProperties \| ((state: Popover.Portal.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Popover.Backdrop.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style        | `React.CSSProperties \| ((state: Popover.Popup.State) => React.CSSProperties \| undefined)`                                   | -       | -                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| style     | `React.CSSProperties \| ((state: Popover.Arrow.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Popover.Title.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Popover.Description.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style        | `React.CSSProperties \| ((state: Popover.Close.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
...
| style     | `React.CSSProperties \| ((state: Popover.Viewport.State) => React.CSSProperties \| undefined)` | -       | -                                                                                                                                                                                             |
