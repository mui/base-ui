...
- **Use Combobox for values**: Choose [Combobox](/react/components/combobox) when users are searching for a value to select, the list is large, or the results need virtualization or asynchronous loading.
