...
<Subtitle>Provides shared state to a series of radio buttons.</Subtitle>
<Meta
  name="description"
  content="A high-quality, unstyled React radio group component that provides shared state to a series of radio buttons."
/>
...
import { TypesRadioGroup } from './types';

<TypesRadioGroup.RadioGroup />

### Root

<TypesRadioGroup.Root />

### Indicator

<TypesRadioGroup.Indicator />
