    ...
    <div className="flex items-center gap-4">
      <div className="flex items-center gap-2">
        <Toggle
          ...
          className="box-border m-0 flex size-8 items-center justify-center rounded-none border-0 bg-transparent p-0 text-neutral-950 select-none dark:text-white hover:not-data-disabled:bg-neutral-100 active:not-data-disabled:bg-neutral-200 dark:hover:not-data-disabled:bg-neutral-800 dark:active:not-data-disabled:bg-neutral-700 focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-neutral-950 dark:focus-visible:outline-white"
          render={(props, state) => (
      ...
      <button
        type="button"
        className="box-border m-0 flex h-8 items-center justify-center rounded-none border border-neutral-950 bg-white text-neutral-950 dark:border-white dark:bg-neutral-950 dark:text-white px-3 py-0 font-[inherit] text-sm leading-none font-normal whitespace-nowrap select-none hover:bg-neutral-100 active:bg-neutral-200 dark:hover:bg-neutral-800 dark:active:bg-neutral-700 focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-neutral-950 dark:focus-visible:outline-white"
