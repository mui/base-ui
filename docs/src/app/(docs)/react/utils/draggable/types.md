...
type DraggableRootPropsWithPayload<TPayload, TDragData = unknown> = {
   ...
   * Without this callback, drag data starts as `undefined`.
   */
  getDragData?: (context: MoveStartContext) => TDragData;
  /**
...
type DraggableuseDragDropManagerReturnValue = {
  ...
  registerDraggable:
    ...
    | (<TKind extends DragKind<undefined, any> = DragKind<undefined, unknown>>(
        ...
        getParameters: () => {
          payload?: undefined;
          getDragData?: (context: MoveStartContext) => TDragData | unknown;
          previewKey?: string | number;
