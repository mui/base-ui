  ...
  return (
    <React.Fragment>
      <section className="bui-d-c">
        <h1 className="Text Text-size-3 bp2:size-4 bui-gcs-1 bui-gce-9 bp4:bui-gce-5">
          Design Engineer
        </h1>
        <div className="bui-gcs-1 bui-gce-9">
          <Link
            className="Text Text-size-2 bui-d-if"
      ...
      <section className="bui-d-c">
        <div className="bui-gcs-1 bui-gce-9 bp2:bui-gce-3">
          <h2 className="Text Text-size-2">About Base UI</h2>
        </div>
        <div className="bui-d-f bui-fd-c bui-g-4 bui-gcs-1 bui-gce-9 bp2:bui-gcs-3 bp4:bui-gce-7">
          <p className="Text Text-size-2">
      ...
      <section className="bui-d-c">
        <div className="bui-gcs-1 bui-gce-9 bp2:bui-gce-3">
          <h2 className="Text Text-size-2">Responsibilities</h2>
        </div>
        <div className="bui-d-f bui-fd-c bui-g-4 bui-gcs-1 bui-gce-9 bp2:bui-gcs-3 bp4:bui-gce-7">
          <ul className="BulletList Text Text-size-2">
      ...
      <section className="bui-d-c">
        <div className="bui-gcs-1 bui-gce-9 bp2:bui-gce-3">
          <h2 className="Text Text-size-2">Requirements</h2>
        </div>
        <div className="bui-d-f bui-fd-c bui-g-4 bui-gcs-1 bui-gce-9 bp2:bui-gcs-3 bp4:bui-gce-7">
          <ul className="BulletList Text Text-size-2">
      ...
      <section className="bui-d-c">
        <div className="bui-gcs-1 bui-gce-9 bp2:bui-gce-3">
          <h2 className="Text Text-size-2">Benefits</h2>
        </div>
        <div className="bui-d-f bui-fd-c bui-g-4 bui-gcs-1 bui-gce-9 bp2:bui-gcs-3 bp4:bui-gce-7">
          <ul className="BulletList Text Text-size-2">
      ...
      <section className="bui-d-c">
        <div className="bui-gcs-1 bui-gce-9 bp2:bui-gce-3">
          <h2 className="Text Text-size-2">Application</h2>
        </div>
        <div className="bui-d-f bui-fd-c bui-g-4 bui-gcs-1 bui-gce-9 bp2:bui-gcs-3 bp4:bui-gce-7">
          <p className="Text Text-size-2">The hiring process will consist of 6 stages:</p>
          <ul className="BulletList Text Text-size-2">
            <li>Resume review.</li>
