      ...
      <section className="d-c">
        <div className="d-f fd-c g-4 gcs-1 gce-9 bp2:gcs-3 bp4:gce-7">
          <p className="Text size-2">
            ...
            Base&nbsp;UI is a comprehensive UI component library for building
            accessible user interfaces with React.
          </p>
          <p className="Text size-2">
            Each Base UI component is meticulously designed for composability,
            consistency, and craft. The library's architecture prioritizes
            flexibility—without imposing visual opinions—helping teams craft
            distinctive interfaces that are fundamentally accessible and reliable.
          </p>
          <p className="Text size-2">
            Collectively, we've been building component libraries for multiple
            decades. We've learned what works, what lasts, and what doesn't. And we
            really, really sweat the details.
          </p>
          <p className="Text size-2">
            Base UI is built to last. It is designed with care and maintained with
            intent. Our mission is to provide a future-proof foundation for
            professional interface design on the Web.
          </p>
        </div>
      </section>
          ...
          <Accordion.Root className="AccordionRoot">
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  Base UI is a library of unstyled UI components for building
                  accessible component libraries, user interfaces, web applications,
                  and websites with React. Base UI components are highly
                  configurable, composable, and customizable.
                </p>
              </Accordion.Panel>
            </Accordion.Item>
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  Yes. Base UI works with Tailwind, CSS Modules, CSS-in-JS, plain
                  CSS, and any other styling library you prefer. It also works with
                  JavaScript animation libraries like Motion, or just plain CSS
                  transitions. Base UI is an unstyled component library. The package
                  does not bundle any CSS, and does not prescribe any styling
                  solution.
                </p>
              </Accordion.Panel>
            </Accordion.Item>
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  ...
                  . Base UI is compliant with all Success Criteria levels relating to
                  component behavior. However, in most cases, we go way beyond these
                  guides. Base UI components are tested across a wide range of
                  browsers, devices, platforms, and environments, and are designed to
                  be accessible.
                </p>
              </Accordion.Panel>
            </Accordion.Item>
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <div className="d-f fd-c g-4">
                  <p className="Text size-2">
                    In terms of API design, both libraries are very similar. We
                    intentionally kept our APIs close to Radix UI for an easier
                    migration path. Base UI provides more complex components such as
                    Combobox and Autocomplete. Base UI also provides deeper feature
                    support such as input scrubbing, nested dialogs, and triggering
                    menus on hover. Base UI is more robust and more polished in terms
                    of a11y and edge case handling.
                  </p>
                  <p className="Text size-2">
                    But the most important difference is that Base UI is actively
                    maintained and developed, with a dedicated team of 7 developers,
                    designers, and managers working on it full-time.
                  </p>
                </div>
              </Accordion.Panel>
            </Accordion.Item>
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  Base UI is a React library. It is not designed to be used without
                  React. We may consider supporting other libraries at some point,
                  but for the foreseeable future, React is our primary focus.
                </p>
              </Accordion.Panel>
            </Accordion.Item>
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  Yes. Base UI is licensed under the MIT license, and is free for
                  commercial use. You are free to use it in your commercial projects,
            ...
            <Accordion.Item className="AccordionItem">
              ...
              <Accordion.Panel className="AccordionPanel">
                <p className="Text size-2">
                  Not currently. We do provide dedicated support channels to some
                  very large enterprise companies who are working with us as design
                  partners. But we do not currently provide Service Level Agreements,
                  guaranteed response times, issue escalation, feature
                  prioritization, or any other formal support guarantees.
                </p>
              </Accordion.Panel>
            </Accordion.Item>
          </Accordion.Root>
