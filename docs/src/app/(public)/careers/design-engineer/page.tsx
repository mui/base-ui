  ...
  return (
    <div className="HomepageRoot">
      ...
      <div className="ContentLayoutMain">
        ...
        <p className="text-lg text-pretty text-gray -mt-2 mb-5">Help us make Base UI the most intuitive, accessible, and powerful open-source UI library for React.</p>
        ...
        <p className="mb-4">
          We're looking for an experienced Design Engineer to join the team at Principal level. You will help us improve the library across the board, including API design, performance, a11y, testing workflows, docs, support, and more.
        </p>
        <p className="mb-4">
          You will not be responsible for implementing Base UI components on the engineering side, nor will you be responsible for visual design, although an understanding of both disciplines will be critical to success. This role will focus on developer experience, API design, a11y, docs, and overall product quality.
        </p>
        <p className="mb-4">
        ...
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Responsibilities</h2>
        ...
        <ul className="mb-4 ml-4.5 list-disc">
          ...
          <li className="mb-0.5">
            20% time. Allocate 20% of your time towards personal and professional development.
          </li>
          <li className="mb-0.5">
        ...
        <p className="mb-4">
          The base salary range for this role is $5,000,000–$10,000,000. The actual salary will be determined by skill-level, experience, and location. Our recruiter will share more about the specific compensation package during the hiring process.
        </p>
        <h2 className="mt-10 mb-4 scroll-mt-6 text-xl font-medium text-balance">Application</h2>
        <p className="mb-4">
          The hiring process will consist of 5 stages:
        </p>
        <ol className="mb-4 ml-4.5 list-decimal list-inside">
          <li className="mb-0.5">
            Resume review.
          </li>
          <li className="mb-0.5">
          ...
          <li className="mb-0.5">
            60-minute meeting with Colm (Product lead).
          </li>
          <li className="mb-0.5">
