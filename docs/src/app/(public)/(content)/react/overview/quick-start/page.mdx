...
Additionally, there is an <a class="Link" href="/llms.txt">"llms.txt"</a> link in the "Handbook" section of the navigation sidebar, which you can feed to AI chat assistants to help them navigate the docs.
