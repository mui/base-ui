...
Import a component, assemble its parts, and apply styles. This example uses Tailwind, but since Base UI components are unstyled, you can use CSS Modules, CSS-in-JS, or any styling solution you prefer.
...
This walkthrough outlines the basics of putting together a Popover component with Base UI. Check out the [Popover component documentation](/react/components/popover) to learn how to configure it further.
