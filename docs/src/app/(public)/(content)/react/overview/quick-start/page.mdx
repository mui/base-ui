...
For those of you working with LLMs, each docs page has a "View as Markdown" link at the top, which can share share with AI chat assistants to help them understand Base UI concepts and component APIs.

Additionally, there is an "llms-full.txt" link in the "Handbook" section of the navigation sidebar, which you can feed to AI chat assistants to help them navigate the docs.
