...
- **Breaking change:** Add `Progress.Label` and `locale` prop ([#1666](https://github.com/mui/base-ui/pull/1666))
...
- **Breaking change:** Add `Content` part ([#1607](https://github.com/mui/base-ui/pull/1607))
...
- **Breaking change:** Improve item highlight performance ([#1570](https://github.com/mui/base-ui/pull/1570))
