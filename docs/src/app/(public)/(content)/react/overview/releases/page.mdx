...
- Move logic from hooks to components ([#1964](https://github.com/mui/base-ui/pull/1964))
...
- Stop event propagation ([#1871](https://github.com/mui/base-ui/pull/1871))
- Button components use `useButton` ([#1802](https://github.com/mui/base-ui/pull/1802))
- Exclude number formatting from form value ([#1957](https://github.com/mui/base-ui/pull/1957))
...
- Use `useRenderElement` ([#1707](https://github.com/mui/base-ui/pull/1707))
- Stop event propagation ([#1871](https://github.com/mui/base-ui/pull/1871))
