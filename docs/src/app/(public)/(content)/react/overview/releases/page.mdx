...
- **Breaking change:** Sync highlight props.
  ...
  ([#3377](https://github.com/mui/base-ui/pull/3377))

### Menu

- Sync highlight props ([#3377](https://github.com/mui/base-ui/pull/3377))
...
- Fix omitted `value` behavior ([#3373](https://github.com/mui/base-ui/pull/3373))
