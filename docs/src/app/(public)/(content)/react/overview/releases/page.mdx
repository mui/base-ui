...
This is a hotfix release with a fix for rendering of Alert Dialog, Dialog, Menu, Popover, and Tooltip in React Server Components ([#3241](https://github.com/mui/base-ui/pull/3241)).
