...
- Place `overflow: hidden` on `<body>` for overlay scrollbars ([#3083](https://github.com/mui/base-ui/pull/3083))
...
- Accepts style prop as function ([#3038](https://github.com/mui/base-ui/pull/3038))
...
- Fix `initialFocus` as function being called on close ([#2949](https://github.com/mui/base-ui/pull/2949))
- Add `role="combobox"` to Trigger if Input is inside Popup ([#2973](https://github.com/mui/base-ui/pull/2973))
- Fix stale `onItemHighlighted` data when filtering with `autoHighlight` ([#2829](https://github.com/mui/base-ui/pull/2829))
- Add empty and side styling attributes on `Input` ([#2926](https://github.com/mui/base-ui/pull/2926))
- Fix Value component return type for React 17 ([#3050](https://github.com/mui/base-ui/pull/3050))
...
- Allow <kbd>Esc</kbd> to bubble if `Empty` is not used ([#2935](https://github.com/mui/base-ui/pull/2935))
...
- Fix `Home`/`End` Input scroll in Chrome/Safari ([#2928](https://github.com/mui/base-ui/pull/2928))
- Prevent blocking filtering while composing text on Android ([#2944](https://github.com/mui/base-ui/pull/2944))
- Add empty state to `List.State` ([#2934](https://github.com/mui/base-ui/pull/2934))
- Fix `initialFocus` as function being called on close ([#2949](https://github.com/mui/base-ui/pull/2949))
- Add `role="combobox"` to Trigger if Input is inside Popup ([#2973](https://github.com/mui/base-ui/pull/2973))
...
- Rollback `CompositeList` to use counter-based update ([#2880](https://github.com/mui/base-ui/pull/2880))

### Context Menu

- Add open state to trigger ([#3195](https://github.com/mui/base-ui/pull/3195))
- Fix ignored positioner anchor prop ([#3202](https://github.com/mui/base-ui/pull/3202))
...
- **Breaking change:** Add `'onSubmit'` validation mode.
  T
  ODO: DESCRIBE THE BREAKING CHANGE.
  ([#3013](https://github.com/mui/base-ui/pull/3013))
...
- Mark disabled in Menubar Context as required ([#2924](https://github.com/mui/base-ui/pull/2924))
...
- Update the handle API ([#3065](https://github.com/mui/base-ui/pull/3065))
- Place `overflow: hidden` on `<body>` for overlay scrollbars ([#3083](https://github.com/mui/base-ui/pull/3083))
