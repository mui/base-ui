...
- Default `tabIndex` to `0` ([#1939](https://github.com/mui/base-ui/pull/1939))
...
- Use `useRenderElement` ([#1771](https://github.com/mui/base-ui/pull/1771))
- Stop event propagation ([#1871](https://github.com/mui/base-ui/pull/1871))
...
- **Breaking change:** Support implicit `Field.Label`.
  If `Field.Label` encloses Checkbox, the `htmlFor`/`id` attributes are no longer explicitly set to associate them.
...
- Create new `ContextMenu` component ([#1665](https://github.com/mui/base-ui/pull/1665))
...
- Create the Menubar component ([#1684](https://github.com/mui/base-ui/pull/1684))
...
- Fix typos ([#2139](https://github.com/mui/base-ui/pull/2139))
- Handle layout resize while open ([#2070](https://github.com/mui/base-ui/pull/2070))
...
- Handle touch momentum scrolling for programmatic scroll check ([#2111](https://github.com/mui/base-ui/pull/2111))
...
- Add `collisionAvoidance` prop ([#1849](https://github.com/mui/base-ui/pull/1849))
- Revert `placeholder` API ([#1985](https://github.com/mui/base-ui/pull/1985))
- Performance: avoid re-renders ([#1961](https://github.com/mui/base-ui/pull/1961))
- Fix close toggle when rendering non-native button ([#2071](https://github.com/mui/base-ui/pull/2071))
- Fix re-render warning in `Positioner` on fallback ([#2089](https://github.com/mui/base-ui/pull/2089))
- Fix `Field.Label` focusing trigger ([#2118](https://github.com/mui/base-ui/pull/2118))
- Fix position flicker when no default value is set ([#2110](https://github.com/mui/base-ui/pull/2110))
...
- Fix inverted flag in item mouseleave ([#2179](https://github.com/mui/base-ui/pull/2179))
...
- Fix return type ([#1968](https://github.com/mui/base-ui/pull/1968))
