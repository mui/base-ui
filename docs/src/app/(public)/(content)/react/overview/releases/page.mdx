...
- [popups] Fix `onOpenChange` types for `event`/`reason` passing ([#1721](https://github.com/mui/base-ui/pull/1721))
- [popups] Use consistent `inert` attr and map `[data-popup-open]` back to `open` ([#1650](https://github.com/mui/base-ui/pull/1650))
- Fix text selection & right-clicks ([#1702](https://github.com/mui/base-ui/pull/1702))

### CheckboxGroup

- [CheckboxGroup] Parent checkbox/nested demos ([#1610](https://github.com/mui/base-ui/pull/1610))
