...
<Reference
  component="Combobox"
  parts="Input, Icon, List, Portal, Positioner, Popup, Arrow, Status, Empty, Collection, Row, Item, Group, GroupLabel, Separator"
/>
...
Allow users to add new options that are not in the predefined list.
