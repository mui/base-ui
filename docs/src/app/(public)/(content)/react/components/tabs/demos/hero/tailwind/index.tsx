  ...
  return (
    <Tabs.Root className="rounded-md border border-gray-200" defaultValue="overview">
      <Tabs.List className="relative z-0 flex gap-1 px-1 shadow-[inset_0_-1px] shadow-gray-200">
        ...
        <Tabs.Indicator className="absolute top-1/2 left-0 z-[-1] h-6 w-[var(--selected-tab-width)] translate-x-[var(--selected-tab-left)] -translate-y-1/2 rounded-sm bg-gray-100 transition-all duration-200 ease-in-out" />
      </Tabs.List>
      <Tabs.Panel
