...
export default function InsideScrollDialog() {
  return (
    <Dialog.Root>
      <Dialog.Trigger className="flex h-10 select-none items-center justify-center rounded-md border border-gray-200 bg-gray-50 px-3.5 text-base font-medium text-gray-900 transition-colors hover:bg-gray-100 active:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-blue-800">
        Open dialog
      </Dialog.Trigger>
