...
The dialog can be made scrollable by making an outer container scrollable while the dialog can extend past the bottom edge.

<Demo path="./demos/outside-scroll" compact />

### Inside scroll dialog

The dialog can be made scrollable by making an inner container scrollable while the popup stays fully on screen.
