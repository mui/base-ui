...
export default function ExampleDialog() {
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Backdrop className="absolute inset-0 bg-black opacity-20 transition-all duration-150 data-[ending-style]:opacity-0 data-[starting-style]:opacity-0 dark:opacity-70" />
