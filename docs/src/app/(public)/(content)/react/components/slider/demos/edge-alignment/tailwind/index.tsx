  ...
  return (
    <Slider.Root thumbAlignment="edge" defaultValue={25}>
      <Slider.Control className="flex w-56 touch-none items-center select-none">
        <Slider.Track className="h-4 w-full rounded-full bg-gray-200 border border-gray-200  select-none">
          <Slider.Indicator className="rounded-l-full bg-white select-none" />
