...
Pointer interactions allow thumbs to pass each other, whereas keyboard interactions keep them from crossing to avoid disorientation when changing focus between thumbs.
