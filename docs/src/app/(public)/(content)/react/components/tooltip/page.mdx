...
- **Avoid for critical information**: Tooltips are a great way to provide additional information about an element for sighted desktop users, but they should be used to provide supplementary information, not critical information. Opt for a `Popover` on an icon button near the tool for critical information instead.
