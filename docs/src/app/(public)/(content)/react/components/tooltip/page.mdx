...
The `TrackCursorAxis` component enables the ability for the tooltip to track the user's mouse cursor, and if so, which axis should be tracked.

<Demo path="./demos/track-cursor" />
