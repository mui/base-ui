...
- Wrap `<Toast.Provider>` around your entire app. No matter where you queue a toast from, they will stack in the same viewport.
...
The created object has the same properties and methods as the `Toast.useToast()` hook.
