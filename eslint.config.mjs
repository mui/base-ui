...
export default defineConfig(
  ...
  },
  {
    ...
    rules: {
      'mocha/no-top-level-hooks': 'off', // not needed
      ...
      // disable some mocha rules
      'mocha/no-async-suite': 'off', // not needed
      'mocha/no-identical-title': 'off', // not needed
    },
  },
  baseSpecRules,
  {
  ...
  },
  {
    ...
    files: [
      'docs/src/app/(public)/(content)/**/demos/**/*{.tsx,.js}',
      'docs/src/app/(private)/experiments/**/*{.tsx,.js}',
    ],
