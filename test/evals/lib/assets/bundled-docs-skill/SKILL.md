---
name: base-ui
description: Build React UIs with Base UI (@base-ui/react) headless components — import conventions, compound component anatomy, how to verify the current API against the installed package, and where to find the bundled markdown documentation.
---
...
under `node_modules/@base-ui/react/docs/react/`. Read these alongside the
types — composition rules, behaviour, and accessibility wiring are documented
there but are not always expressible in TypeScript:
