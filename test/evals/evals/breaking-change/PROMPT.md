# Build a fruit-picker combobox with a reset control
...
- Inside the field, include a button that empties it back to nothing.
- The user can also open the full list without typing, and an empty-state
  message shows when nothing matches.
- Use Base UI's combobox component for all of this — do not hand-roll the
  filtering, dropdown, reset, or accessibility behaviour.
