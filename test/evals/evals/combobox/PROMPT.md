...
- The user can clear the field, and can open the full list without typing.
- When the typed text matches no fruit, the dropdown shows an empty-state
  message.
- Use Base UI's combobox component for all of this — do not hand-roll the
  filtering, dropdown, or accessibility behaviour.
