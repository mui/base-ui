...
/**
 * A textarea that can be used as the input surface for the autocomplete.
 * Renders a `<textarea>` element.
 */
export const AutocompleteTextarea = React.forwardRef(function AutocompleteTextarea(
  componentProps: AutocompleteTextarea.Props,
...
export namespace AutocompleteTextarea {
