...
describe('<NavigationMenu.Root />', () => {
  ...
  describe('nested menus', () => {
    ...
    describe('inline nested viewport', () => {
      ...
      it('clears fixed popup sizing when the window resizes while the menu is open', async () => {
        await render(<TestNavigationMenuWithKeepMountedContent />);
        ...
        await waitFor(() => {
          expect(popupRoot.style.getPropertyValue('--popup-width')).to.equal('');
          expect(popupRoot.style.getPropertyValue('--popup-height')).to.equal('');
          expect(positioner.style.getPropertyValue('--positioner-width')).to.equal('');
          expect(positioner.style.getPropertyValue('--positioner-height')).to.equal('');
        });
      });
