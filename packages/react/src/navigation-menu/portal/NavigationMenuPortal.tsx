...
export interface NavigationMenuPortalProps extends PortalCommonProps<NavigationMenuPortalState> {
  /**
   ...
   */
  container?: PortalCommonProps<NavigationMenuPortalState>['container'] | undefined;
}
