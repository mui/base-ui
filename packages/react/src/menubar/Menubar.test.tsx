...
describe('<Menubar />', () => {
  ...
  describe('item removal', () => {
    it('keeps the tab stop on the highlighted trigger when an earlier menu is removed', async () => {
      function App({ showFirst }: { showFirst: boolean }) {
        return (
          <Menubar>
            {showFirst && (
              <Menu.Root>
                <Menu.Trigger data-testid="first">File</Menu.Trigger>
              </Menu.Root>
            )}
            <Menu.Root>
              <Menu.Trigger data-testid="middle">Edit</Menu.Trigger>
            </Menu.Root>
            <Menu.Root>
              <Menu.Trigger data-testid="last">View</Menu.Trigger>
            </Menu.Root>
          </Menubar>
        );
      }
    ...
    it('keeps a tab stop when the highlighted menu is removed', async () => {
