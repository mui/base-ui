...
export class PopoverHandle<Payload> {
   ...
   * and register without a mounted root. Its reads always reflect a closed popover and its mutations
   ...
   */
  private readonly fallbackStore = createNullPopoverStore<Payload>();
   ...
   */
  private readonly attachedStores: PopoverStore<Payload>[] = [];
   ...
   */
  private attachedStore: PopoverStore<Payload> | null = null;
   ...
   * @internal
   */
  get store(): PopoverHandleStore<Payload> {
   ...
   * cleanup function that detaches the store again. Called by `Popover.Root`.
   * @internal
   */
  attachStore(newStore: PopoverStore<Payload>) {
   ...
   */
  private setActiveStore(store: PopoverStore<Payload> | null) {
