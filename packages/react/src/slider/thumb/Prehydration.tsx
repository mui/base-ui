    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: `(${(() => {
          ...
          const indicator = control.querySelector<HTMLElement>('[data-base-ui-slider-indicator]');
          const controlRect = control.getBoundingClientRect();
          const vertical = control.getAttribute('data-orientation') === 'vertical';
          const side = vertical ? 'height' : 'width';
          const inputElems = control.querySelectorAll<HTMLInputElement>('input[type="range"]');
