  ...
  if (event.key === ARROW_UP) {
    ...
    if (domBasedCandidate !== undefined) {
      ...
      if (prevIndex === -1) {
        ...
        if (focusLoop && (prevIndex - cols < minIndex || nextIndex < 0)) {
  ...
  if (event.key === ARROW_DOWN) {
    ...
    if (domBasedCandidate !== undefined) {
      ...
      if (prevIndex === -1) {
        ...
        if (focusLoop && prevIndex + cols > maxIndex) {
          nextIndex = findNonDisabledListIndex(listRef, {
  ...
  if (orientation === 'both') {
    ...
    if (event.key === (rtl ? ARROW_LEFT : ARROW_RIGHT)) {
      ...
      if (prevIndex % cols !== cols - 1) {
        ...
        if (focusLoop && isDifferentGridRow(nextIndex, cols, prevRow)) {
          nextIndex = findNonDisabledListIndex(listRef, {
