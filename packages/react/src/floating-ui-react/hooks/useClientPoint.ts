...
export function useClientPoint(
  ...
  const setReference = useUntrackedCallback((newX: number | null, newY: number | null) => {
  ...
  const handleReferenceEnterOrMove = useUntrackedCallback((event: React.MouseEvent<Element>) => {
    if (x != null || y != null) {
      return;
    }
