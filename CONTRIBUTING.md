...
- `docs/src/app/(docs)/react/page.mdx` is the **autogenerated** combined React docs index used to build the sitemap and navigation. Do not edit it manually. It is regenerated when running `pnpm docs:dev` (on page visit), `pnpm docs:build`, or `pnpm docs:validate`.
