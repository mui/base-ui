...
function CommandInput({
  ...
  return (
    <div className="py-1.5 ps-1 pe-2.5">
      <AutocompleteInput
        autoFocus
        className={cn(
...
function CommandFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex items-center justify-between gap-3 rounded-b-[calc(var(--radius-2xl)-1px)] border-t px-5 py-3 text-muted-foreground text-xs z-10",
        className,
      )}
