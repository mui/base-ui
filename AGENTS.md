...
You MUST run `pnpm extract-error-codes` to update `docs/public/static/error-codes.json` every time you add or update an error message in an `Error` constructor.
