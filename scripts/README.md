...
4. Generate the changelog in a format suitable for the docs with `pnpm release:changelog:docs` and copy it to `docs/src/app/(docs)/react/overview/releases/page.mdx`.
